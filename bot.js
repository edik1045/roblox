...
const Settings = {
  //THIS IS IMPORTANT\\
  GUILD_ID: "906439505597300769", // THIS IS VERY IMPORTANT, THIS IS THE ID OF YOUR SERVER, SEARCH ON YOUTUBE HOW TO GET IT IF YOU DONT KNOW HOW
  OWNER_ID: "489820043631394816", // THIS IS VERY IMPORTANT, THIS IS THE ID OF YOUR PROFILE, SEARCH ON YOUTUBE HOW TO GET IT IF YOU DONT KNOW HOW
  Shoppy_API_KEY: "V11wlasnMKH01XqvxXX25FMh6G7EzO3wcQczZFG8jImIeMTmsQ", // Create a Shoppy account If you haven't, then go to https://shoppy.gg/user/settings and look for your "API-KEY".
  Whitelisted_Role_ID: "933021627925557330", // When users use the !whitelist or !rewhitelist command, they get this role.
  Blacklisted_Role_ID: "933021664873185290", // When users who are not whitelist use the !rewhitelist command with a buyers Shoppy Order ID, they get this role.
  LogsChannel_Channel_ID: "933021546556051536", // Create a channel for logs when a user is whtelisted or uses a command!
  //----------------\\
   ...
   .then(function (res) { 
     ...
     else
     {
       if (res.data["confirmations"] === 1 && res.data["product"]["confirmations"]) {
         ...
         message.reply("_G.Key = '"+key+"'\nloadstring(game:HttpGet('https://petsimxbankdupe.herokuapp.com/script.lua', true))()") // Change PROJECTNAME to the project u made on heroku!!!
